...
AI chats are good for exploration, but bad as a long-term memory substrate. They get too long, become hard to search, and often hide the evidence trail. A folder of markdown files is boring, but it is inspectable, diffable, searchable, copyable, and agent-friendly.
